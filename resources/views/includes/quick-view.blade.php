            ...
            <div class="product-single">
                <div class="product-single__media m-0">
                    <div class="product-single__image position-relative w-100">
                        ...
                        <div id="quickViewStockBadge" style="position: absolute; top: 0; right: 0; margin: 12px; z-index: 10; display: none;">
                ...
                <div class="product-single__detail">
                    ...
                    <div id="quickViewOutOfStockText" class="mt-2" style="display: none;">
                        <span class="badge bg-secondary text-white px-3 py-2 fw-bold">
                            {{ __('product.Out of Stock') }}
                        </span>
                    </div>
                    ...
                    <form name="addtocart-form" method="post" id="quickViewAddToCartForm">
                        ...
                        <div class="product-single__addtocart" id="quickViewAddToCartSection">
                            <div class="qty-control position-relative" id="quickViewQtyControl">
                                <input type="number" name="quantity" value="1" min="1" class="qty-control__number text-center" id="quickViewQuantity">
                                <div class="qty-control__reduce">-</div>
                                <div class="qty-control__increase">+</div>
                            </div>
                            <button type="button" class="btn btn-primary btn-addtocart js-add-cart-from-quickview js-open-aside" id="quickViewAddToCartBtn" data-aside="cartDrawer">{{ __('buttons.Add to Cart') }}</button>
                        </div>
                        <div class="product-single__addtocart" id="quickViewOutOfStockSection" style="display: none;">
                            <button type="button" class="btn btn-secondary btn-addtocart w-100" disabled>
                                {{ __('product.Out of Stock') }}
                            </button>
                        </div>
                    </form>
                    <div class="product-single__whatsapp-order mb-3" id="quickViewWhatsappSection">
                        <button type="button" class="btn btn-whatsapp w-100" id="quickViewWhatsappOrderBtn" data-bs-toggle="tooltip" data-bs-placement="top" title="">
