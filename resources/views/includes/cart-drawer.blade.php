...
<div class="aside aside_right overflow-hidden cart-drawer" id="cartDrawer">
    <div class="aside-header d-flex align-items-center">
        <h3 class="text-uppercase fs-6 mb-0">SHOPPING BAG ( <span class="cart-amount js-cart-items-count">0</span> ) </h3>
    ...
    <div class="cart-drawer-actions position-absolute start-0 bottom-0 w-100">
        ...
        <div class="d-flex justify-content-between align-items-center mb-2" id="cartDiscount" style="display: none; padding: 8px 0; border-bottom: 1px dashed #dee2e6;">
            <h6 class="fs-base fw-medium mb-0">{{ __('Discount') }}:</h6>
        ...
        <a href="{{ route('cart.index', app()->getLocale()) }}" class="btn btn-light mt-3 d-block" id="viewCartBtn" style="display: none;">View Cart</a>
